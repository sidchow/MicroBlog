...
public class TestIO {
	...
	public static void main(String[] args) {
		...
		String savefilepath="/Users/chungmingchow/Desktop/comp_Java/c/"+user.getUserName()+".blog";
		...
		String loadfilepath="/Users/chungmingchow/Desktop/comp_Java/c/"+user.getUserName()+".blog";
		    //if the path is not accessible, change it to any path you can access
		...
		anyblog.load("/Users/chungmingchow/Desktop/comp_Java/d/non-exist.blog");
